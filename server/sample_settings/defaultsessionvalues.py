...
DEFAULTMORPHTABLES = True
DEFAULTMORPHDIALECTS = False
DEFAULTMORPHDUALS = True
DEFAULTMORPHEMPTYROWS = True
DEFAULTMORPHFINITE = True
DEFAULTMORPHIMPERATIVES = True
DEFAULTMORPHINFINITIVES = True
DEFAULTMORPHIMPARTICIPLES = True
