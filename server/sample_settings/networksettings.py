...
#
# EXTERNALWSGI means that you are not using the built-in server but are serving via nginx+gunicorn vel sim. If you
...
GOLANGPROVIDESWEBSOCKETS = False
GOLANGTHWSBINARYNAME = 'HipparchiaGoWebSocketApp'