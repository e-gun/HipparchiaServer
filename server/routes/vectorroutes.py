...
from server.semanticvectors.vectorhelpers import findverctorenvirons, tfbuilddataset, tfgeneratetrainingbatch, \
	findwordvectorset, tidyupmophdict, finddblinefromsentence, tfplotwithlabels
...
def tftest(sentences):
	...
	vocabularysize = min(10000, len(set(allwordsinorder)))

	dataset = tfbuilddataset(allwordsinorder, vocabularysize)
