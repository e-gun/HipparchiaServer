...
def probeforsessionvariables():
	...
	try:
		...
		session['morphtables'] = hipparchia.config['DEFAULTMORPHTABLES']
		session['morphdialects'] = hipparchia.config['DEFAULTMORPHDIALECTS']
		session['morphduals'] = hipparchia.config['DEFAULTMORPHDUALS']
		session['morphemptyrows'] = hipparchia.config['DEFAULTMORPHEMPTYROWS']
		session['morphfinite'] = hipparchia.config['DEFAULTMORPHFINITE']
		session['morphimper'] = hipparchia.config['DEFAULTMORPHIMPERATIVES']
		session['morphinfin'] = hipparchia.config['DEFAULTMORPHINFINITIVES']
		session['morphpcpls'] = hipparchia.config['DEFAULTMORPHIMPARTICIPLES']
